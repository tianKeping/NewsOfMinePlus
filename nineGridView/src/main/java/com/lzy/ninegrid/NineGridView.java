...
public class NineGridView extends ViewGroup {
    ...
    public NineGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        System.out.println(Tools.getScreenWidth(context) + "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ");
        singleImageSize = Tools.px2dip(context, Tools.getScreenWidth(context));
        System.out.println(singleImageSize + "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ");
        singleImageSize = (int) Tools.dip2px(getContext(), singleImageSize);
